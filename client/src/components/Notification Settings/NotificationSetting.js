...
const NotificationSetting = ({
  ...
  const [selectedOrder, setSelectedOrder] = useState(
    notification.order_status.split(",")
  );
      ...
      {loading ? (
        ...
        <div className="mt-3 mb-3">
          <div style={{ textAlign: "right" }}>
            <Button primary onClick={() => syncData()}>
              SYNC DATA
            </Button>
          </div>
          <form onSubmit={onSubmit}>
                    ...
                    <Layout.Section>
                      <div className="input-sm">
                        <input
                          ...
                          type="number"
                          name="numberOfLive"
                          defaultValue={notification.number_of_live}
                  ...
                  <Layout.Section>
                    <div className="time-display">
                      <input
                        className="input-form"
                        type="number"
                        name="nextTimeDisplay"
                        defaultValue={notification.time_loop}
                        onChange={onChangeData}
                      />
                ...
                <Layout.Section>
                  <div className="time-display">
                    <input
                      ...
                      type="number"
                      name="displaytime"
                      defaultValue={notification.time_display}
                      onChange={onChangeData}
                    />
                    <span className="seconds">seconds</span>
                  </div>
              ...
              <Layout>
                ...
                <Layout.Section>
                  <input
                    ...
                    type="text"
                    name="text_popup"
                    defaultValue={notification.text_popup}
                    onChange={onChangeData}
                  />
                  <p className="note-text p-0">
                    If you want to show the customer's name, lets put "%name"
                    you in the text box. Do the same with the customer's city.
                    Or instead of show the customer's name you can replace
                    "%name" with "Someone". And "%city" it works with city.
            ...
            <div className="mb-3 mt-3">
              <Layout>
                <Layout.Section secondary></Layout.Section>
                <Layout.Section>
                  <Button size="large" primary submit={true}>
                    Save
                  </Button>
                </Layout.Section>
              </Layout>
            ...
            <div>
              {stateEffect === true ? (
                <div
                  ...
                  id="show-demo"
                  className={`animate__animated animate__${hidden} animate__${display} notification`}
                >
                  <div style={{ padding: 0 }}>
