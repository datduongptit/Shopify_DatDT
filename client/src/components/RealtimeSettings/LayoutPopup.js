...
const LayoutPopup = ({
  ...
  const [checked, setChecked] = useState(realtimeSetting.type);
  ...
  const [colorRight, setColorRight] = useState(
    realtimeSetting.background_right
  );
  const onChangeColorRight = (e) => {
    setColorRight(([e.target.name] = e.target.value));
  };

  const [color, setColor] = useState(realtimeSetting.background_popup);
  ...
  console.log(formData.show_product);
            ...
            <Layout>
              ...
              <Layout.Section>
                <input
                  ...
                  type="checkbox"
                  name="orderChecked"
                  value={Boolean(realtimeSetting.show_product)}
              ...
              <Layout.Section>
                ...
                <Layout.Section secondary>
                  ...
                  <Layout.Section>
                    <div style={{ display: "flex" }}>
                      <RadioButton
                        checked={checked === "background_popup"}
                        onChange={handleChange}
                        id="background_popup"
                        name="checked"
                      />
          ...
          <div className="mb-3 mt-3">
            <Layout>
              ...
              <Layout.Section>
                ...
                {typeof realtimeSetting.random_min === "number" &&
                  ...
                  <div className="mb-3">
                    <div className="mb-3 ml-5">
                      ...
                      <input
                        ...
                        defaultValue={
                          formData.random_min === ""
                            ? (formData.random_min = "0")
                            : realtimeSetting.random_min
                        }
                        onChange={onChange}
                        className="input-ssm"
                      />
                    ...
                    <div className="mb-3 ml-5">
                      ...
                      <input
                        ...
                        name="random_max"
                        defaultValue={
                          formData === "" ? "0" : realtimeSetting.random_max
                        }
                        onChange={onChange}
                        className="input-ssm"
                      />
